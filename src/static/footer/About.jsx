...
const About = () => {
  return (
    <div className="grid place-items-center h-screen">
      <Card className="w-2/3 mt-16 dark:bg-blue-gray-700">
        <div className="grid place-items-center">
          <CardHeader
            className="grid -mt-16  mb-8 h-28 w-fit lg:w-1/3 md:w-1/2 place-items-center"
            color="deep-orange"
            variant="gradient"
          >
            <Typography variant="h2" className="mx-2 dark:text-gray-300">
              About the Website
            </Typography>
          </CardHeader>
        </div>
        <CardBody className="w-7/8 ml-4">
          <Typography variant="paragraph" color="gray" className="text-left dark:text-gray-300">
        ...
        <CardFooter className="text-left" divider>
          <Typography className="bottom-0 left-0 dark:text-gray-400" variant="small" color="gray">
